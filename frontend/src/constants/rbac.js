...
export const PLATFORM_ROLES = {
  ...
  HR_PAYROLL_USER: {
    ...
    badge: 'HPU',
    scope: 'Run Payroll Operations',
    description: 'Operational payroll user with rights to compute payruns, draft payslips, and inspect attendance logs for payroll cycles.',
    color: 'blue',
    userCount: 3
  },
  HR_PAYROLL_MANAGER: {
    ...
    badge: 'HRP',
    scope: 'Run HR & Payroll',
    description: 'Unified HR & full payroll command. Complete access to employee contracts, salary structures, rule formulas, and payrun validation.',
    color: 'purple',
    userCount: 2
  },
  ADMIN: {
